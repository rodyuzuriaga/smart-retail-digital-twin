...
// import gemeloImg from '../gemelo.png'; // Not available

const DigitalTwinBanner = () => (
    <div className="w-full h-80 bg-gray-900 rounded-3xl overflow-hidden relative flex items-center justify-center">
        <div className="absolute inset-0 bg-gradient-to-br from-[#009639]/20 to-blue-500/20 mix-blend-overlay"></div>
        <div className="text-center">
             <Binary size={64} className="text-white/20 mx-auto mb-4" />
             <p className="text-white/40 font-mono text-sm">Visualización de Gemelo Digital</p>
        </div>
    </div>
);
        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="bg-white rounded-2xl border border-gray-200 h-[400px] relative overflow-hidden group shadow-lg">
            ...
            <div className="w-full h-full bg-gray-900 flex items-center justify-center relative">
                ...
                <div className="text-center">
                     <Binary size={64} className="text-white/20 mx-auto mb-4" />
                     <p className="text-white/40 font-mono text-sm">Visualización de Gemelo Digital (Simulación)</p>
                </div>
            </div>
